...
echo "  2. Start sprint tracking: sprint_start MCP tool"
echo "  3. Research external APIs with context7 BEFORE writing integration code"
echo "  4. Code → typecheck → commit to feature branch"
echo "  5. sprint_progress MCP tool after each commit"
echo "  6. Background review after tasks with NEW patterns (incremental-review recipe)"
echo "  7. Full code review + security review before PR"
echo "  8. sprint_complete MCP tool → compound.sh extract"
